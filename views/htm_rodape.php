      ...
      <div class="row">
        ...
        <div id="contato" class="col-xs-12 col-sm-4 contato-destaque">
          ...
          <div style="margin-top:15px;">
            ...
            <div style="float: left;">
              <div class="rodape_textos" style="margin-top:-3px;"><?=$_base['rodape_contato1']['conteudo']?></div>
...
.footer_bottom {
    ...
    position: relative; /* Importante: Define o contexto de posicionamento para a logo */
    overflow: hidden;
}
...
.logo-overlay {
    position: absolute; /* Posiciona a logo em relação ao .footer_bottom */
    top: -30px; /* Ajuste conforme necessário para posicionar acima */
    left: 50%;
    transform: translateX(-50%);
    z-index: 10; /* Garante que a logo fique acima de outros elementos */
    width: 100px; /* Largura da sua logo */
    height: 50px; /* Altura da sua logo */
    background-color: #fff; /* Fundo para a logo, se ela não tiver um */
    border-radius: 5px;
...
.btn-radio {
  right: 20px;
  bottom: 100px; /* Ajustado para não sobrepor o player */
}
...
@media (max-width: 600px) {
  ...
  /* Ajustes mobile para contato */
  .contato-destaque > div {
    margin-bottom: 10px;
  }
  
  .contato-destaque div[style*="float"] {
...
/* Correção adicional para redes sociais */
.redessociais_rodape {
