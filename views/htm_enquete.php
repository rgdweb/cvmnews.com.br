...
<head>
  ...
  <title>Enquete - <?=$_base['titulo_pagina']?></title>
              ...
              <div id="conteudo" style="padding-top: 80px;">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8" >
                    ...
                    <div class="titulo_padrao" >ENQUETE</div>
                ...
                <div class="row">                  
                  ...
                  <div class="col-sm-2"></div>
                  <div class="col-sm-8">
                    <div style="margin-bottom: 100px; margin-top: 50px; width: 100%; margin-left: 20% margin-right:20%;">

                      <div class="enquete_pergunta"><?=$enquete['pergunta']?></div>

                      <div style="padding-bottom: 50px; ">
                        <?php
                        foreach ($enquete_respostas as $key => $value) {

                          echo "
                          <div class='enquete_resposta' style='margin-top:20px;' >
                          <label for='resposta_".$value['codigo']."' >".$value['texto']."</label>
                          <div style='font-size:14px;'>".$value['votos_porc']." % dos votos</div>
                          <div style='margin-top:5px; width:".$value['votos_porc']."%; height:5px; background-color:#000;'></div>
                          </div>
                          ";
