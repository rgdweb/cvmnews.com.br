         	...
         	<div class="nav-tabs-custom">
              ...
              <a href="#dados" data-toggle="tab">Dados</a>
  				...
  				<div class="tab-content" >
                    ...
                    <!-- INÍCIO DO FORMULÁRIO SUBSTITUÍDO E ADAPTADO -->
                    <form action="<?=$_base['objeto']?>alterar_grv" class="form-horizontal" method="post">

  						<fieldset>
                
                            <div class="form-group">
                                <label class="col-md-12" >Título do Vídeo</label>
                                <div class="col-md-6">
                                    <input name="titulo" type="text" class="form-control" value="<?=$data->titulo?>" required>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-12" >ID do Vídeo do YouTube</label>
                                <div class="col-md-6">
                                    <input name="video" type="text" class="form-control" value="<?=$data->video?>" placeholder="ex: Ga33aOwceAM" required>
                                </div>
                            </div>
